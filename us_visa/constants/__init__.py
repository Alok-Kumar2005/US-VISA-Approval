...
MODEL_BUCKET_NAME = "usvisa-model2024-a"  ## these is the bucket name at aws S3
MODEL_PUSHER_S3_KEY = "model-reistry"

### MODEL_BUCKET_NAME = "usvisa-model2024-a"  ##  on S3 bucket
